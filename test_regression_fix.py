#!/usr/bin/env python3
"""
Test script to verify the regression training fix.
"""
...
def test_regression_consistency():
    """Test that regression loss and metrics are consistent."""
    
    print("🧪 Testing Regression Training Fix")
    print("=" * 50)
    ...
    print(f"   Sequence len: {config['data']['seq_len']}")
    ...
    print("\n🎉 Regression training fix test completed!")

if __name__ == "__main__":
    test_regression_consistency() 